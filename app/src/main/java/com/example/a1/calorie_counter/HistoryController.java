...
public class HistoryController extends AppCompatActivity {
    ...
    static Double sumOfCalories;
    static Double sumOfMoveCal;
    static Double sumOfEatCal;
    TextView textView;
        ...
        ref_basicInfo.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (getStartModel != null) {
                    Double currentWeight = getStartModel.getCurrentWeight();
                    Double targetWeight = getStartModel.getTargetWeight();


                    if(currentWeight > targetWeight &&
                            sumOfCalories >=0){
                        //setting current date
                        calendar.set(20, 6, 26);
                    }
                }
            }
        ...
        ref_history.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                for (int i =0; i < historyArrayList.size(); i++){
                    Double totalCalories = Double.valueOf(historyArrayList.get(i).getTotalCalories());
                    sumOfCalories += totalCalories;
                    if(totalCalories>0){
                        sumOfEatCal += totalCalories;
                    }else{
                        sumOfMoveCal += totalCalories;
                    }
                }
